...
const PixelMap = (() => {
  ...
  const THEMES = {
    classic: {
      ...
      guests: [
        { hair: "#3b2b20", skin: "#f2c9a0", cloth: "#e08aa5", pants: "#4a5a7a" },
        { hair: "#1f1a18", skin: "#e8b88c", cloth: "#7ec0e0", pants: "#3a3a4a" },
        { hair: "#6b4a2f", skin: "#f7d6b4", cloth: "#e8c85c", pants: "#5a4a6b" },
        { hair: "#2b2440", skin: "#e0a87c", cloth: "#84c98a", pants: "#4a4a5a" },
      ],
    },
    princess: {
      name: "공주풍",
      ...
      guests: [
        { hair: "#8a6a4a", skin: "#f7d6b4", cloth: "#fbc2dd", pants: "#b59ad0" },
        { hair: "#3b2b20", skin: "#f2c9a0", cloth: "#e0c2f5", pants: "#9a8ac0" },
        { hair: "#c98a4a", skin: "#f7d6b4", cloth: "#fdeaa8", pants: "#c2a8d8" },
        { hair: "#2b2440", skin: "#e8b88c", cloth: "#c2e4f5", pants: "#a890c0" },
      ],
    },
    european: {
      name: "유럽풍",
      ...
      guests: [
        { hair: "#1f1a18", skin: "#e8b88c", cloth: "#8f2f3a", pants: "#3a3020" },
        { hair: "#5a4632", skin: "#f2c9a0", cloth: "#2f5a3a", pants: "#4a3a2a" },
        { hair: "#3b2b20", skin: "#e0a87c", cloth: "#455680", pants: "#3a3020" },
        { hair: "#8a6a4a", skin: "#f7d6b4", cloth: "#c2a35a", pants: "#4a3a2a" },
      ],
    },
    neon: {
      name: "네온 라운지",
      ...
      guests: [
        { hair: "#1f1a28", skin: "#e8b88c", cloth: "#00d8f0", pants: "#241a3f" },
        { hair: "#2b2440", skin: "#f2c9a0", cloth: "#f03fa0", pants: "#1c1030" },
        { hair: "#6b4a2f", skin: "#e0a87c", cloth: "#a86bff", pants: "#241a3f" },
        { hair: "#1f1a18", skin: "#f7d6b4", cloth: "#5affc2", pants: "#2e2050" },
      ],
    },
    japanese: {
      name: "일본풍",
      ...
      guests: [
        { hair: "#1f1a18", skin: "#f2c9a0", cloth: "#2f4a78", pants: "#3a3550" },
        { hair: "#2b2440", skin: "#f7d6b4", cloth: "#c23a33", pants: "#4a3a3a" },
        { hair: "#3b2b20", skin: "#e8b88c", cloth: "#f2ece0", pants: "#5a4a42" },
        { hair: "#1f1a18", skin: "#f2c9a0", cloth: "#2f5a50", pants: "#3a3550" },
      ],
    },
  };
